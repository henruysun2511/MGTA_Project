...
export default function ExerciseCard({ item, classListData, skillListData }) {
  ...
  return (
    <div className="practice-item">
      ...
      <div className="button button-detail" onClick={() => navigate(`/admin/exerciseDetailMana/:${item.id}`)}>
        Xem chi tiết
      </div>
